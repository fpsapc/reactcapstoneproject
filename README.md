...
**[reactcapstoneproject]** this project displays a list of crypto currencies. A user can select a currency to see its details or user can find required currency by name.
...
- **[Allow user to check crypto details]**
- **[User can find crypto by nam]**
...
```
https://github.com/fpsapc/reactcapstoneproject
```

- Navigate to the location of the folder in your machine:

**``you@your-Pc-name:~$ cd reactcapstoneproject``**
